...
This module provides pretrain, SFT, and PEFT configurations for GLM MOE DSA models:
...
# =============================================================================
# Internal helpers — shared configuration for all GLM MOE DSA recipes
# =============================================================================


def _glm_moe_dsa_apply_common(
    cfg: ConfigContainer,
    hf_path: str,
    *,
    tp: int,
...
def _glm_moe_dsa_apply_moe(cfg: ConfigContainer, *, ep: int, etp: int = 1) -> None:
...
def _glm_moe_dsa_enable_recompute(cfg: ConfigContainer) -> None:
...
def _glm_moe_dsa_apply_peft_scheme(cfg: ConfigContainer, peft_scheme: str | PEFT) -> None:
