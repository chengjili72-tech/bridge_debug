...
from mindspeed_bridge.models.qwen_vl.modelling_qwen3_vl.attention import (
    Qwen3VLSelfAttention,
)
from mindspeed_bridge.models.qwen_vl.modelling_qwen3_vl.rope import get_rope_index
from mindspeed_bridge.models.qwen_vl.modelling_qwen3_vl.text_model import (
    Qwen3VLGPTModel,
)
from mindspeed_bridge.models.qwen_vl.modelling_qwen3_vl.transformer_config import (
    Qwen3VLTransformerConfig,
    get_vision_model_config,
)
from mindspeed_bridge.models.qwen_vl.modelling_qwen3_vl.utils import (
...
from mindspeed_bridge.models.qwen_vl.modelling_qwen3_vl.vision_model import (
    Qwen3VLVisionModel,
)
...
class Qwen3VLModel(MegatronModule):
    ...
    def _expose_language_model_for_cuda_graph_helper(self) -> None:
        ...
        llm_cuda_graph_enabled = (
            self.language_model is not None and getattr(self.language_model.config, "cuda_graph_impl", "none") != "none"
        )
                ...
                if vision_data.shape[0] > 0:
                    if self.use_dist_train:
                        if self.vision_model is not None:
                            ...
                            torch.cuda.nvtx.range_pop("Qwen3VLModel.forward.pre_process")
