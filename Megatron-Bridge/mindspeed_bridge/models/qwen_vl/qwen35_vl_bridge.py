...
from mindspeed_bridge.models.conversion.param_mapping import GDNLinearMappingSeparate
...
class Qwen35VLMoEBridge(Qwen3VLMoEBridge):
    ...
    def provider_bridge(self, hf_pretrained: PreTrainedVLM) -> Qwen35VLMoEModelProvider:
        ...
        provider.mtp_num_layers = getattr(text_config, "mtp_num_hidden_layers", None)
...
class Qwen35VLBridge(MegatronModelBridge):
    ...
    def provider_bridge(self, hf_pretrained: PreTrainedVLM) -> Qwen35VLModelProvider:
        ...
        provider.share_embeddings_and_output_weights = getattr(hf_config, "tie_word_embeddings", False)
        provider.mtp_num_layers = getattr(hf_config, "mtp_num_hidden_layers", None)
        ...
        for mtp_layer in range(num_mtp_layers):
            ...
            mapping_list.extend(
                [
                    ...
                    GatedMLPMapping(
                        megatron_param=f"language_model.mtp.layers.{mtp_layer}.transformer_layer.linear_fc1.weight*",
