...
te_checkpoint = None
if HAVE_TE:
    from megatron.core.extensions.transformer_engine import te_checkpoint  # pylint: disable=ungrouped-imports
                        ...
                        if self.pre_process and deepstack_visual_embeds is not None:
                            ...
                            if l_no in range(len(deepstack_visual_embeds)):
                                hidden_states = self._deepstack_process(
                                    hidden_states,
                                    visual_pos_masks,
                                    deepstack_visual_embeds[l_no],  # pylint: disable=unsubscriptable-object
                                )
